...
seattle_listings.py
-------------------
Nettoyage des colonnes de listings Seattle :
...
RAW_FP = "data/raw/seattle/listings.csv"
OUT_FP = "data/processed/seattle/listings_clean.csv"
...
# -----------------------------
cols_to_drop = [
    # Déjà identifiées comme "À retirer"
...
print(f"\n✅ Seattle listings nettoyé → {OUT_FP}")
